...
| `success` | `#22C55E` | "Locked in" drift feedback, completion |
| `warning` | `#FBBF24` | "Close" drift feedback |
| `error` | `#EF4444` | "Drifting" feedback, errors |
...
| `layerAFaded` | `#818CF840` | Muted layer A (Disappearing Beat) |
| `layerBFaded` | `#FB923C40` | Muted layer B |
...
|---|---|---|
| Minimum tap target | 80px × 80px | Large enough for guided baby taps |
...
| Button height minimum | 56px | Easy one-handed tap |
